...
public class Piece {
    ...
    public void promotePawn(int row, boolean isBlack) {
        if ((isBlack && row == 7) || (!isBlack && row == 0)) {
            ...
            // takes piece choice input from user
            Scanner scanner = new Scanner(System.in);
            String promotedPiece = "";

            while (!promotedPiece.equals("queen") && !promotedPiece.equals("rook") &&
                    !promotedPiece.equals("knight") && !promotedPiece.equals("bishop")) {

                System.out.println("Choose a piece to promote Pawn to (Queen, Rook, Knight, Bishop): ");
                promotedPiece = scanner.nextLine().trim().toLowerCase();
            }

            // changes the character of the piece according to the input given
